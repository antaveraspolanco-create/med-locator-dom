...
import { Download, Activity, Hospital, Stethoscope } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="gradient-primary">
        <div className="container mx-auto px-4 py-6 gap-3 border-secondary border-none rounded-md shadow-sm flex items-center justify-center bg-[#092f58]">
